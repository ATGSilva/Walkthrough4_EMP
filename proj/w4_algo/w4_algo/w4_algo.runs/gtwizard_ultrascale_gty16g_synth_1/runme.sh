...
HD_PWD='/storage1/ag17009/IPBB_TestBuilds/w4_emp/proj/w4_algo/w4_algo/w4_algo.runs/gtwizard_ultrascale_gty16g_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gtwizard_ultrascale_gty16g.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gtwizard_ultrascale_gty16g.tcl
