...
HD_PWD='/storage1/ag17009/IPBB_TestBuilds/w4_emp/proj/w4_algo/w4_algo/w4_algo.runs/myfunc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log myfunc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source myfunc_0.tcl
