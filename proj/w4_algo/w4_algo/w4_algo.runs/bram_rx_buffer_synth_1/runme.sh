...
HD_PWD='/storage1/ag17009/IPBB_TestBuilds/w4_emp/proj/w4_algo/w4_algo/w4_algo.runs/bram_rx_buffer_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bram_rx_buffer.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bram_rx_buffer.tcl
